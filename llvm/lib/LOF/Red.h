...
namespace lof {
  ...
  namespace lof {
    ...
    public:
      void internal_setReachableDefs(ArrayRef<std::pair< Red*, int>> ReachableDefs, bool TopIsReachableDef) {
      ...
      void internal_addPossibleUse(int Idx, Red* Use) {
        if (!PossibleUses) {
          PossibleUses = std::make_unique<ScalarPossibleUses[]>(cast<Green>(G)->getNumChildren());
        }
    ...
    public:
      ...
      auto dfs(SetTy& Visited) { Visited.clear(); return llvm::depth_first_ext(this, Visited); }
  ...
  namespace llvm {
    GraphTraits<lof:: Red *>::ChildIteratorType GraphTraits<lof:: Red *>::child_begin(NodeRef N) { return N->children().begin(); }
    GraphTraits<lof:: Red *>::ChildIteratorType GraphTraits<lof:: Red *>::child_end(NodeRef N)   { return N->children().end(); }

    GraphTraits<lof:: Red *>:: nodes_iterator GraphTraits<lof:: Red *>:: nodes_begin(lof:: Red* R) { return nodes_iterator::begin(getEntryNode(R));  }
    GraphTraits<lof:: Red *>:: nodes_iterator GraphTraits<lof:: Red *>:: nodes_end  (lof:: Red *R) { return nodes_iterator::end(getEntryNode(R));    }
  } // namespace llvm
  ...
  public:
    RedDumper(llvm::raw_ostream& OS, bool OnlyStmts =false,const Red *Highlight = nullptr) : OS(OS) , Highlight(Highlight), OnlyStmts(OnlyStmts) {}
