...
/// Node in an immutable tree, contains reference to parent and corresponding
/// green node (which stores the children)
class RedNode {
public:
  class const_child_iterator
      : public iterator_facade_base<
            const_child_iterator, std::forward_iterator_tag, const RedNode *> {
  private:
    const RedNode *parent;
    ArrayRef<const GreenNode *>::iterator git;

  public:
    const_child_iterator(const RedNode *parent,
                         ArrayRef<const GreenNode *>::iterator git)
        : parent(parent), git(git) {}
    ...
    const RedNode *operator*() const { return parent->getChild(git); }

    RedNode *operator*() { return parent->getChild(git); }
...
protected:
  RedNode(RedNode *Parent, const GreenNode *Green)
      : Parent(Parent), Green(Green) {
    assert(Green);
...
public:
  ...
  iterator_range<const_child_iterator> children() const {
    ...
    return make_range(const_child_iterator(this, Children.begin()),
                      const_child_iterator(this, Children.end()));
  }

  auto children_unexpanded() const
      -> llvm::iterator_range<decltype(Children.begin())> {
    return make_range(Children.begin(), Children.end());
  }

  // Does not implicitly expand red nodes
  // Possible alternative: PointerUnion<RedNode*,GreenNode*> which is a
  // GreenNode if the RedNode is not expanded yet.
  auto children_redgreen() const
      -> decltype(zip(getGreen()->children(),
                      make_range(Children.begin(), Children.end()))) {
    //  auto GreenRange = getGreen()->children();
    auto RedRange = make_range(Children.begin(), Children.end());
    return zip(getGreen()->children(),
               make_range(Children.begin(), Children.end()));
  }
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenSequence::classof(Node->getGreen());
  }
  static bool classof(const RedSequence *) { return true; }

  const GreenSequence *getGreen() const {
    return static_cast<const GreenSequence *>(RedNode::getGreen());
  }
};
...
private:
  ...
  static void assignDefinitions(RedNode *Node,
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenRoot::classof(Node->getGreen());
  }
  static bool classof(const RedRoot *) { return true; }

  const GreenRoot *getGreen() const {
    return static_cast<const GreenRoot *>(RedNode::getGreen());
  }

  static RedRoot *Create(GreenRoot *Green) { return new RedRoot(Green); }
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenBlock::classof(Node->getGreen());
  }
  static bool classof(const RedBlock *) { return true; }

  const GreenBlock *getGreen() const {
    return static_cast<const GreenBlock *>(RedNode::getGreen());
  }
};
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenLoop::classof(Node->getGreen());
  }
  static bool classof(const RedLoop *) { return true; }

  const GreenLoop *getGreen() const {
    return static_cast<const GreenLoop *>(RedBlock::getGreen());
  }
};
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenStmt::classof(Node->getGreen());
  }
  static bool classof(const RedStmt *) { return true; }

  const GreenStmt *getGreen() const {
    return static_cast<const GreenStmt *>(RedBlock::getGreen());
  }
};
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenInst::classof(Node->getGreen());
  }
  static bool classof(const RedInst *) { return true; }

  const GreenInst *getGreen() const {
    return static_cast<const GreenInst *>(RedNode::getGreen());
  }
};
...
public:
  static bool classof(const RedNode *Node) {
    return GreenStore::classof(Node->getGreen());
  }
  static bool classof(const RedStore *) { return true; }

  const GreenStore *getGreen() const {
    return static_cast<const GreenStore *>(RedInst::getGreen());
  }
...
public:
  static bool classof(const RedNode *Node) {
    return GreenSet::classof(Node->getGreen());
  }
  static bool classof(const RedSet *) { return true; }

  const GreenSet *getGreen() const {
    return static_cast<const GreenSet *>(RedInst::getGreen());
  }
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenExpr::classof(Node->getGreen());
  }
  static bool classof(const RedExpr *) { return true; }

  const GreenExpr *getGreen() const {
    return static_cast<const GreenExpr *>(RedNode::getGreen());
  }
};
...
public:
  ...
  static bool classof(const RedNode *Node) {
    return GreenConst::classof(Node->getGreen());
  }
  static bool classof(const RedConst *) { return true; }

  const GreenConst *getGreen() const {
    return static_cast<const GreenConst *>(RedExpr::getGreen());
  }
};
...
public:
  ...
  const GreenArg *getGreen() const {
    return static_cast<const GreenArg *>(RedExpr::getGreen());
  }
};
...
public:
  static bool classof(const RedNode *Node) {
    return GreenReg::classof(Node->getGreen());
  }
  static bool classof(const RedConst *) { return true; }

  const GreenReg *getGreen() const {
    return static_cast<const GreenReg *>(RedExpr::getGreen());
  }
  Value *getVar() const { return getGreen()->getVar(); }

  RedSet *getDef() const { return Def; }
...
public:
  ...
  static bool classof(const RedReg *Node) {
    return GreenGEP::classof(Node->getGreen());
  }
  static bool classof(const RedConst *) { return true; }

  const GreenGEP *getGreen() const {
    return static_cast<const GreenGEP *>(RedExpr::getGreen());
  }
};
...
public:
  ...
  static bool classof(const RedReg *Node) {
    return GreenICmp::classof(Node->getGreen());
  }
  static bool classof(const RedConst *) { return true; }

  const GreenICmp *getGreen() const {
    return static_cast<const GreenICmp *>(RedExpr::getGreen());
  }
};
} // namespace llvm
