...
namespace llvm {
  ...
  CallInst *AtomicInfo:: emitLibCall(StringRef fnName,
    ...
    std::pair<Value *, Value *> AtomicInfo::
  EmitAtomicCompareExchangeOp(Value *ExpectedVal, Value *DesiredVal,
    ...
    return std::make_pair(PreviousVal, SuccessFailureVal);
      ...
      Value * AtomicInfo:: EmitAtomicCompareExchangeLibcall(Value *ExpectedPtr, Value *DesiredPtr,
    ...
    return emitLibCall( "__atomic_compare_exchange",  IntegerType::getInt1Ty(C), Args);
  }


  AtomicResult AtomicInfo::
